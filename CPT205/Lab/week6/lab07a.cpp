...
These function pointers are defined for pointing to the various shape functions, i.e., sphere(), cube() and
cone(). */
void(*A)(void);
void(*B)(void);
// functions 
...
// algorithm: find where A is inside B, and then find where 
//            B is inside A 
